...
/*   Updated: 2023/02/12 10:27:34 by polpi            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "push_swap.h"

int	main_error(int ac, char **av, t_stack *stack)
{
	if (ac == 1 || av[1][0] == '\0')
		return (0);
...
int	main_duplicate(int ac, char **av, t_stack *stack)
{
...
int main(int ac, char **av) 
{
	...
	if (main_duplicate(ac, av, &stack) == 0)
		return (0);
	choose_algo(&stack);
	// if (ac == 2)
	// 	free_av(av);
